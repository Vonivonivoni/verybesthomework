class FavoritesController < ApplicationController
  def index
    ...
    @favorites = @q.result(:distinct => true).includes(:favorite_dish, :favorite_venues, :location, :venues, :user).page(params[:page]).per(10)
  ...
  def create
    ...
    @favorite.username_id = params[:username_id]
