class VenuesController < ApplicationController
  def index
    ...
    @venues = @q.result(:distinct => true).includes(:cuisine, :dishes, :favorites, :location, :list_of_favorites).page(params[:page]).per(10)
  ...
  def create
    ...
    @venue.favorites_id = params[:favorites_id]
